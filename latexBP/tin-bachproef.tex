...
\newcommand{\titel}{Anti-Cheating binnen Gaming \& eSports voor FPS games die in lijn ligt met een opkomend online platform}
...
% resultaten.
Binnen de sector eSports en Gaming is Cheating een van de grootste opkomende problemen. De gamewereld is een groeinde sector waarbij er meer en meer geld mee valt te verdienen waardoor er ook vaker wordt valsgespeeld. De spelers kunnen een onfair voordeel halen die van heel klein kan gaan naar zo goed als volledig niet meer zelf spelen. De bedoeling is dan ook om dit tegen te gaan en een competitie die gespeeld wordt te controleren op eerlijkheid via "anti-cheating". 

In dit onderzoek ga ik op zoek naar de populairste methodes om vals te spelen: hoe deze werken, wat ze verwezenlijken een vergelijking van functionaliteit enz. 
...
We bevinden ons momenteel binnen de eSports scene. eSports staat voor "electronic sports" \citep{BenDirs2015}. Dit is een overkoepelende term voor alles dat met competitief gamen te maken heeft. Spelers gaan in de strijd om een kans te maken op de ophogende prijzenpotten die oplopen tot wel 18 miljoen dollar. \citep{dota2theinternational}
...
Midden in een spel "Counter-Strike: Global Offensive" kan de ene speler het niet meer aan om te verliezen. Op dit moment beslist hij 
\lipsum[7-20]
